...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@krontrack.local')
...
SOCIAL_AUTH_MICROSOFT_OAUTH2_KEY = ''
SOCIAL_AUTH_MICROSOFT_OAUTH2_SECRET = ''
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'integrations.pipeline.create_employee_profile',
)
